...
public partial class db_a3cb5b_webbienesraicesEntities : DbContext
{
    ...
    public virtual int IngresaPropiedad(string nombrePro, string descripcion, Nullable<decimal> precioPro, string provincia, string canton, string distrito, Nullable<int> idProvincia, Nullable<int> idCanton, Nullable<int> idDistrito, string direccionExacta, Nullable<int> cantidadCuarto, Nullable<int> cantidadBano, Nullable<int> cantidadGarajes, Nullable<int> categoriaPro, string ruta, Nullable<int> metrosCasa, Nullable<int> metrosLote)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("IngresaPropiedad", nombreProParameter, descripcionParameter, precioProParameter, provinciaParameter, cantonParameter, distritoParameter, idProvinciaParameter, idCantonParameter, idDistritoParameter, direccionExactaParameter, cantidadCuartoParameter, cantidadBanoParameter, cantidadGarajesParameter, categoriaProParameter, rutaParameter, metrosCasaParameter, metrosLoteParameter);
    }


    public virtual ObjectResult<MostrarPropiedad_Result> MostrarPropiedad(Nullable<int> precio02, Nullable<int> canCuato, Nullable<int> canBano, Nullable<int> canGara, Nullable<int> cate, string provincia, string canton, string distrito)
    {
    ...
    public virtual int ModificarPropiedad(Nullable<int> idPropi, string nombrePro, Nullable<decimal> precio, string estado, Nullable<int> categoria, string des, string nombreProvincia, string nombreCanton, string nombreDistrito, Nullable<int> idProvincia, Nullable<int> idCanton, Nullable<int> idDistrito, string direccionExacta, Nullable<int> cuartos, Nullable<int> banos, Nullable<int> garajes, Nullable<int> metrosCasa, Nullable<int> metrosPropiedad)
    {
    ...
    public virtual ObjectResult<MostrarPropiedadAdmin_Result> MostrarPropiedadAdmin(Nullable<int> precio02, Nullable<int> canCuato, Nullable<int> canBano, Nullable<int> canGara, Nullable<int> cate, string estado, string provincia, string canton, string distrito)
    {
    ...
    public virtual ObjectResult<MostrarTresPropiedades_Result> MostrarTresPropiedades()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MostrarTresPropiedades_Result>("MostrarTresPropiedades");
    }
