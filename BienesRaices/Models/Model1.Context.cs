...
namespace BienesRaices.Models
{
    ...
    public partial class db_a3cb5b_webbienesraicesEntities : DbContext
    {
        ...
        public virtual int CargarImagenesModificar(Nullable<int> id, string ruta)
        {
        ...
        public virtual int ModificarPropiedad(Nullable<int> idPropi, string nombrePro, string precio, string estado, Nullable<int> categoria, string des, string nombreProvincia, string nombreCanton, string nombreDistrito, Nullable<int> idProvincia, Nullable<int> idCanton, Nullable<int> idDistrito, string direccionExacta, Nullable<int> cuartos, Nullable<int> banos, Nullable<int> garajes, Nullable<int> metrosCasa, Nullable<int> metrosPropiedad, Nullable<int> idPrioridad, string tipoMoneda, string precioAntes, Nullable<bool> apartado)
        {
